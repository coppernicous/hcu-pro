...
estimado de cuántos estudiantes están usando y disfrutando gratamente estas características.</p>
      ...
      atDomReady('ls_campusMain', function() {
        ...
        let items2Del = [
          ...
          ['#divAlumnoAvisoCarne', '.row', 'Aviso carnet'],
          ...
          ['#divModal211', '.row', 'Descargar la app'],
          ['#divModal213', '.row', 'Día del emprendedor'],
          ['#divModal222', '.row', 'Carné universitario'],
